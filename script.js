...
(() => {
  ...
  const KANJI_MNEMONICS = {
    一: {
      radicals: [{ char: "一", meaning: "One stroke" }],
      origin:
        "A single horizontal stroke — the simplest possible character, representing the number one.",
      mnemonic:
        "Picture a single flat stick lying on the ground: just one line, just the number ONE.",
    },
    二: {
      radicals: [{ char: "二", meaning: "Two strokes" }],
      origin:
        "Two stacked horizontal strokes, doubling the single stroke of 一.",
      mnemonic:
        "Picture two sticks stacked one above the other — TWO lines for the number two.",
    },
    三: {
      radicals: [{ char: "三", meaning: "Three strokes" }],
      origin:
        "Three stacked horizontal strokes, continuing the pattern from 一 and 二.",
      mnemonic:
        "Picture three sticks stacked neatly on top of each other — THREE lines for the number three.",
    },
    四: {
      radicals: [{ char: "四", meaning: "Enclosure + legs" }],
      origin:
        "An enclosure with two legs inside — an old way of writing the number four that later lost its literal picture-meaning.",
      mnemonic:
        "Picture a box with two little legs kicking around inside it — that wriggling box holds the number FOUR.",
    },
    五: {
      radicals: [{ char: "五", meaning: "Crossing balance" }],
      origin:
        "Originally a crossing pattern representing balance at the midpoint of the numbers one through ten.",
      mnemonic:
        "Picture a pair of scales balancing perfectly at FIVE, right in the middle of one to ten.",
    },
    六: {
      radicals: [{ char: "六", meaning: "Roof/hut" }],
      origin:
        "A pictograph of a simple hut or roof, borrowed early on to represent the number six.",
      mnemonic:
        "Picture a little roof with just enough room for SIX people to shelter underneath it.",
    },
    七: {
      radicals: [{ char: "七", meaning: "A cut/division" }],
      origin:
        "A cross-shaped mark originally used to represent a cut or division, later borrowed for the number seven.",
      mnemonic:
        "Picture a knife making one clean cut across a stick — a single SEVEN-shaped slice.",
    },
    八: {
      radicals: [{ char: "八", meaning: "Splitting apart" }],
      origin:
        "A pictograph of something splitting apart into two diverging strokes.",
      mnemonic:
        "Picture a stick of butter split cleanly in two, the halves fanning outward — that split shape is EIGHT.",
    },
    九: {
      radicals: [{ char: "九", meaning: "Bent arm/hook" }],
      origin:
        "Originally a pictograph of a bent arm or hook, borrowed for the number nine.",
      mnemonic:
        "Picture an elbow bending sharply, almost all the way around — bent like the number NINE.",
    },
    十: {
      radicals: [{ char: "十", meaning: "Counting knot" }],
      origin:
        "A simple cross shape, possibly from an ancient counting-knot tied in rope.",
      mnemonic:
        "Picture a plus-sign-shaped knot tied in a rope, used for counting all the way up to TEN.",
    },
    人: {
      radicals: [{ char: "人", meaning: "Person" }],
      origin:
        "A pictograph of a person seen from the side, with two legs mid-stride.",
      mnemonic:
        "Picture a stick-figure PERSON walking, seen from the side with one leg stepping forward.",
    },
    大: {
      radicals: [{ char: "大", meaning: "Person, arms spread" }],
      origin:
        "A pictograph of a person standing with arms and legs stretched wide open.",
      mnemonic:
        "Picture a person standing with their arms flung wide open, showing just how BIG they are.",
    },
    小: {
      radicals: [{ char: "小", meaning: "Tiny grains" }],
      origin:
        "A pictograph of a few tiny grains of sand or dust scattered together.",
      mnemonic:
        "Picture three tiny grains of sand, so SMALL and light they could blow away in the wind.",
    },
    山: {
      radicals: [{ char: "山", meaning: "Mountain" }],
      origin: "A pictograph of three jagged mountain peaks side by side.",
      mnemonic:
        "Picture three jagged MOUNTAIN peaks silhouetted against the sky.",
    },
    川: {
      radicals: [{ char: "川", meaning: "River" }],
      origin: "A pictograph of three flowing lines of water — a river.",
      mnemonic:
        "Picture three parallel streams rushing side by side — that's a RIVER.",
    },
    田: {
      radicals: [{ char: "田", meaning: "Rice field" }],
      origin:
        "A pictograph of a rice paddy viewed from above, divided into a grid of plots.",
      mnemonic:
        "Picture a RICE FIELD from a bird's-eye view, neatly divided into four square plots.",
    },
    日: {
      radicals: [{ char: "日", meaning: "Sun" }],
      origin:
        "A pictograph of the sun, originally drawn as a circle with a dot inside.",
      mnemonic:
        "Picture the SUN as a glowing square window in the sky, marking the day.",
    },
    月: {
      radicals: [{ char: "月", meaning: "Moon" }],
      origin: "A pictograph of a crescent moon.",
      mnemonic: "Picture a thin crescent MOON hanging in the night sky.",
    },
    木: {
      radicals: [{ char: "木", meaning: "Tree" }],
      origin:
        "A pictograph of a tree: the horizontal stroke is the branches, the vertical stroke the trunk, and the sweeping diagonals are roots.",
      mnemonic:
        "Picture a single TREE standing alone, its branches spreading wide and its roots sweeping down into the soil.",
    },
    火: {
      radicals: [{ char: "火", meaning: "Fire" }],
      origin: "A pictograph of flickering flames rising upward.",
      mnemonic:
        "Picture a small campfire, its FLAMES flickering and dancing upward into two little points.",
    },
    水: {
      radicals: [{ char: "水", meaning: "Water" }],
      origin:
        "A pictograph of flowing water: the center stroke is the main current, the side strokes are splashes.",
      mnemonic:
        "Picture a stream of WATER flowing down the middle, with droplets splashing off to each side.",
    },
    金: {
      radicals: [{ char: "金", meaning: "Metal/gold" }],
      origin:
        "A stylized roof shape over two dots representing nuggets of ore buried in the earth.",
      mnemonic:
        "Picture two shiny GOLD nuggets buried under a little roof-shaped mound of earth.",
    },
    土: {
      radicals: [{ char: "土", meaning: "Earth/soil" }],
      origin: "A pictograph of a mound of earth sitting on the ground.",
      mnemonic:
        "Picture a small mound of EARTH piled up on the ground, like a tiny hill of soil.",
    },
    口: {
      radicals: [{ char: "口", meaning: "Mouth" }],
      origin: "A pictograph of an open mouth.",
      mnemonic: "Picture a wide-open square MOUTH, ready to speak or eat.",
    },
    目: {
      radicals: [{ char: "目", meaning: "Eye" }],
      origin:
        "A pictograph of an eye, originally drawn horizontally like an almond before rotating upright.",
      mnemonic:
        "Picture an EYE rotated on its side, the middle line as the pupil looking out at you.",
    },
    耳: {
      radicals: [{ char: "耳", meaning: "Ear" }],
      origin: "A pictograph of the outer shape of an ear.",
      mnemonic: "Picture the curled outer shape of an EAR, ready to listen.",
    },
    手: {
      radicals: [{ char: "手", meaning: "Hand" }],
      origin: "A pictograph of a hand with fingers spread.",
      mnemonic:
        "Picture an open HAND with fingers spread wide, palm facing you.",
    },
    足: {
      radicals: [{ char: "足", meaning: "Leg/foot" }],
      origin: "A bent knee shape sitting on top of a stylized foot.",
      mnemonic:
        "Picture a bent knee resting on top of a FOOT, ready to take a step.",
    },
    心: {
      radicals: [{ char: "心", meaning: "Heart" }],
      origin: "A pictograph of the physical shape of a heart.",
      mnemonic:
        "Picture the curved chambers of a beating HEART, drawn in one flowing shape.",
    },
    女: {
      radicals: [{ char: "女", meaning: "Woman" }],
      origin:
        "A pictograph of a person kneeling gracefully with arms crossed — an old artistic convention for depicting a woman.",
      mnemonic:
        "Picture a woman kneeling gracefully, her arms crossed in front of her.",
    },
    子: {
      radicals: [{ char: "子", meaning: "Child" }],
      origin: "A pictograph of a swaddled baby with arms outstretched.",
      mnemonic:
        "Picture a CHILD wrapped snugly in a blanket, tiny arms poking out to the sides.",
    },
    男: {
      radicals: [
      ...
      origin:
        "田 (a rice field) combined with 力 (physical strength), reflecting the traditional role of a man working the fields.",
      mnemonic:
        "Picture a strong man out in the rice field, flexing his muscles as he works.",
    },
    雨: {
      radicals: [{ char: "雨", meaning: "Rain" }],
      origin:
        "A pictograph of raindrops falling from a cloud, shown as dots beneath a horizontal line.",
      mnemonic: "Picture RAINDROPS falling steadily from a cloud overhead.",
    },
    天: {
      radicals: [
        { char: "一", meaning: "Sky/heaven" },
        { char: "大", meaning: "Big person" },
      ],
      origin:
        "大 (a person standing with arms outstretched) topped with a stroke representing the sky above their head.",
      mnemonic:
        "Picture a giant person standing so tall their head touches the SKY above.",
    },
    中: {
      radicals: [{ char: "中", meaning: "Arrow through center" }],
      origin:
        "A pictograph of an arrow or pole passing straight through the center of a target.",
      mnemonic:
        "Picture an arrow shot straight through the MIDDLE of a target.",
    },
    上: {
      radicals: [{ char: "上", meaning: "Mark above a line" }],
      origin:
        "A short mark placed above a baseline, indicating something positioned 'up' or 'above'.",
      mnemonic: "Picture a small flag planted UP on top of a hill.",
    },
    下: {
      radicals: [{ char: "下", meaning: "Mark below a line" }],
      origin:
        "A short mark placed below a baseline, indicating something positioned 'down' or 'below'.",
      mnemonic: "Picture a small stone dropped DOWN below a ledge.",
    },
    本: {
      radicals: [
        { char: "木", meaning: "Tree" },
        { char: "一", meaning: "Root mark" },
      ],
      origin:
        "A tree 木 with an extra stroke marking its base — the 'root' or 'origin' of the tree.",
      mnemonic:
        "Picture a TREE with a little line marking exactly where its roots begin — the true origin, like the first page of a BOOK.",
    },
    見: {
      radicals: [
        { char: "目", meaning: "Eye" },
        { char: "儿", meaning: "Legs/person" },
      ],
      origin:
        "An eye 目 placed on top of a pair of legs 儿, depicting a person actively looking at something.",
      mnemonic:
        "Picture a person on legs craning their EYE forward to SEE something in the distance.",
    },
    言: {
      radicals: [{ char: "言", meaning: "Words rising" }],
      origin:
        "A pictograph of a mouth with sound waves or words rising out of it.",
      mnemonic:
        "Picture WORDS rising up out of an open mouth like little sound waves — that's SPEECH.",
    },
    食: {
      radicals: [{ char: "食", meaning: "Covered dish" }],
      origin:
        "A stylized image of a covered food dish with steam rising, representing a meal ready to eat.",
      mnemonic:
        "Picture a covered dish of FOOD with steam rising from underneath the lid.",
    },
    力: {
      radicals: [{ char: "力", meaning: "Flexed arm" }],
      origin: "A pictograph of a flexed, muscular arm.",
      mnemonic: "Picture a bent, flexed ARM showing off its muscle and POWER.",
    },
    出: {
      radicals: [{ char: "出", meaning: "Foot stepping out" }],
      origin:
        "A foot stepping out beyond a boundary line, repeated for emphasis.",
      mnemonic:
        "Picture a foot stepping OUT beyond the edge of a doorway, again and again.",
    },
    入: {
      radicals: [{ char: "入", meaning: "Entrance" }],
      origin: "A pictograph of a person ducking down to enter a low doorway.",
      mnemonic:
        "Picture yourself ducking your head down to walk IN through a low tent flap.",
    },
    北: {
      radicals: [{ char: "北", meaning: "Two people back-to-back" }],
      origin:
        "Two people standing back-to-back, facing away from each other — associated with north since traditional buildings faced south.",
      mnemonic:
        "Picture two people standing back-to-back, both facing away toward the cold NORTH wind.",
    },
    先: {
      radicals: [
        { char: "土", meaning: "Path mark" },
        { char: "儿", meaning: "Legs" },
      ],
      origin:
        "A leg shape 儿 placed ahead of a mark representing a path, depicting someone walking ahead of others.",
      mnemonic:
        "Picture someone's legs striding ahead of everyone else — always FIRST, always ahead.",
    },
    生: {
      radicals: [{ char: "生", meaning: "Sprouting plant" }],
      origin: "A pictograph of a young plant sprouting up out of the ground.",
      mnemonic:
        "Picture a tiny green sprout pushing up out of the soil — the beginning of LIFE.",
    },
    休: {
      radicals: [
      ...
      origin:
        "A person 人 leaning against a tree 木 — the original picture of someone taking a break in the shade.",
      mnemonic:
        "Picture a tired person leaning back against a tree trunk to REST in its shade.",
    },
    明: {
      radicals: [
        { char: "日", meaning: "Sun" },
      ...
      origin:
        "The sun 日 placed beside the moon 月 — two of the brightest things in the sky, together.",
      mnemonic:
        "Picture the Sun and Moon shining side by side — when both are out at once, everything looks unmistakably BRIGHT.",
    },
    清: {
      radicals: [
        { char: "氵", meaning: "Water" },
        { char: "青", meaning: "Blue/green" },
      ],
      origin:
        "The three-drop water radical 氵 (a stream or liquid) combined with 青 (originally a sprouting blue-green plant, later 'blue/green' generally).",
      mnemonic:
        "Picture water so CLEAR and pure that it looks blue-green all the way down to the bottom.",
    },
    林: {
      radicals: [
        { char: "木", meaning: "Tree" },
      ...
      origin:
        "Two tree characters 木 placed side by side, doubling up to represent a small stand of trees.",
      mnemonic:
        "Picture two TREES standing close together — enough to call it a small woods.",
    },
    森: {
      radicals: [
        { char: "木", meaning: "Tree" },
      ...
      origin:
        "Three tree characters 木 stacked together, tripling up from 林 to represent a dense forest.",
      mnemonic:
        "Picture three TREES crowded together, so dense you can barely see between them — a full FOREST.",
    },
    話: {
      radicals: [
        { char: "言", meaning: "Speech" },
        { char: "舌", meaning: "Tongue" },
      ],
      origin:
        "The speech radical 言 combined with an element related to the tongue/mouth, together meaning spoken conversation.",
      mnemonic:
        "Picture words pouring out as two people sit face to face, having a TALK.",
    },
    聞: {
      radicals: [
        { char: "門", meaning: "Gate" },
      ...
      origin:
        "An ear 耳 placed inside a gate/doorway 門, as if listening for news arriving from outside.",
      mnemonic:
        "Picture pressing your EAR right up against a closed GATE, straining to HEAR what's happening beyond it.",
    },
    新: {
      radicals: [
      ...
      origin:
        "An axe 斤 cutting into standing wood — originally 'freshly-cut timber', extended to mean 'new'.",
      mnemonic:
        "Picture an axe striking a freshly cut log — the wood is NEW, still pale and unweathered.",
    },
    古: {
      radicals: [
        { char: "十", meaning: "Ten" },
      ...
      origin:
        "Ten 十 generations passed down by mouth 口 — a story told and retold for so long it has become 'old'.",
      mnemonic:
        "Picture a story passed by mouth through TEN generations of grandparents — ancient and OLD.",
    },
    高: {
      radicals: [{ char: "高", meaning: "Tall tower" }],
      origin:
        "A pictograph of a tall multi-story tower or gate, viewed from the side.",
      mnemonic:
        "Picture a TALL tower with multiple stories stacked up HIGH into the sky.",
    },
    安: {
      radicals: [
        { char: "宀", meaning: "Roof" },
      ...
      origin:
        "A woman 女 sitting safely under a roof 宀 — a picture of domestic peace and security.",
      mnemonic:
        "Picture someone relaxing safely under a roof during a storm, feeling completely SAFE and at ease.",
    },
    多: {
      radicals: [
      ...
      origin:
        "Two 'evening' shapes stacked together, representing the passing of many nights.",
      mnemonic: "Picture MANY moons rising, night after night after night.",
    },
    少: {
      radicals: [{ char: "少", meaning: "A few grains" }],
      origin:
        "A few small dots or grains, related in spirit to 小 but emphasizing scarcity rather than size.",
      mnemonic:
        "Picture just a FEW grains of rice left in an otherwise empty bowl.",
    },
    早: {
      radicals: [
        { char: "日", meaning: "Sun" },
        { char: "十", meaning: "Rising mark" },
      ],
      origin:
        "The sun 日 just peeking up above the horizon line, representing the early part of the day.",
      mnemonic:
        "Picture the SUN just barely peeking over the horizon — it's still EARLY morning.",
    },
    長: {
      radicals: [{ char: "長", meaning: "Elder with long hair" }],
      origin:
        "A pictograph of an elderly person with long flowing hair and a walking cane, symbolizing both length and seniority.",
      mnemonic:
        "Picture an elder with long flowing hair down their back, walking with a cane — LONG hair, and the eldest of the group.",
    },
    行: {
      radicals: [{ char: "行", meaning: "Crossroads" }],
      origin:
        "A pictograph of a crossroads viewed from above, where paths lead in different directions.",
      mnemonic:
        "Picture standing at a CROSSROADS with paths leading off in different directions, deciding where to GO.",
    },
    来: {
      radicals: [{ char: "来", meaning: "Ripe wheat stalk" }],
      origin:
        "Originally a pictograph of a ripe stalk of wheat, later borrowed phonetically to mean 'come'.",
      mnemonic:
        "Picture a stalk of wheat swaying as someone walks toward you across the field, finally about to COME and reach you.",
    },
    年: {
      radicals: [
      ...
      origin:
        "Originally a picture of a person carrying a bundle of ripe grain on their back, representing one full harvest cycle.",
      mnemonic:
        "Picture a farmer carrying a huge bundle of grain home after the harvest — one full YEAR's work.",
    },
    待: {
      radicals: [
        { char: "彳", meaning: "Step / road" },
        { char: "寺", meaning: "Temple" },
      ],
      origin:
        "彳 depicts a crossroads or a person's footsteps, and appears in many kanji related to movement or stopping along a path. 寺 ('temple') is added here mainly for its ancient sound value rather than its modern meaning — a common pattern in Japanese where one component hints at MEANING and another hints at SOUND.",
      mnemonic:
        "Picture yourself pacing back and forth (彳) outside a TEMPLE gate (寺), WAITING for it to open.",
    },
    時: {
      radicals: [
        { char: "日", meaning: "Sun" },
      ...
      origin:
        "日 ('sun') supplies the meaning — something related to the passage of the sun, i.e. time — while 寺 again lends mainly its ancient sound value, the same phonetic component seen in 待.",
      mnemonic:
        "Picture watching the SUN (日) slowly cross the sky above a TEMPLE (寺) to tell what TIME it is.",
    },
  };
  ...
  function buildRadicalBreakdownLine(entry, kanjiMeaning) {
    ...
    const parts = entry.radicals
      .map((r) => `${r.char} (${r.meaning})`)
      .join(" + ");
  ...
  // ---- Extensive Reading Hub (Yomitan-style hover dictionary, NEW) ----

  /** Sourcing note: there's no Japanese morphological analyzer (like
   *  Kuromoji/TinySegmenter) in this vanilla-JS build, so true word
   *  segmentation of arbitrary pasted text isn't possible. This is a
   *  script-run heuristic instead: consecutive kanji are grouped as one
   *  lookupable chunk (so compounds like 病院 stay together), consecutive
   *  katakana are grouped (loanwords), consecutive hiragana are grouped,
   *  and everything else (spaces, punctuation, romaji) is left as plain
   *  text. It's not perfect — a hiragana run can span more than one real
   *  word — but Jisho's search tolerates that reasonably well, and it's
   *  honest about being a heuristic rather than a true tokenizer. */
  function tokenizeForReading(text) {
    const re =
      /([\u4E00-\u9FFF々]+)|([\u30A1-\u30FC]+)|([\u3041-\u3096ー]+)|([^\u4E00-\u9FFF々\u30A1-\u30FC\u3041-\u3096ー]+)/g;
    const tokens = [];
    let m;
    while ((m = re.exec(text)) !== null) {
      if (m[4]) tokens.push({ text: m[4], lookupable: false });
      else tokens.push({ text: m[1] || m[2] || m[3], lookupable: true });
    }
    return tokens;
  }

  function buildReadingPaneHTML(text) {
    return tokenizeForReading(text)
      .map((t) =>
        t.lookupable
          ? `<span class="yomitan-word" data-word="${escapeHtml(t.text)}" tabindex="0" role="button" aria-label="Look up ${escapeHtml(t.text)}">${escapeHtml(t.text)}</span>`
          : escapeHtml(t.text),
      )
      .join("");
  }
  ...
  function enterReadMode() {
    const text = document.getElementById("extensiveInput").value.trim();
    if (!text) {
      toast("Paste some Japanese text first");
      return;
    }
    document.getElementById("extensiveReadingPane").innerHTML =
      buildReadingPaneHTML(text);
    document.getElementById("extensiveReadingPane").classList.remove("hidden");
    document.getElementById("extensiveInputWrap").classList.add("hidden");
    document.getElementById("extensiveExitRow").classList.remove("hidden");
  }

  function exitReadMode() {
    document.getElementById("extensiveReadingPane").classList.add("hidden");
    document.getElementById("extensiveInputWrap").classList.remove("hidden");
    document.getElementById("extensiveExitRow").classList.add("hidden");
    hideYomitanTooltip();
  }

  // ---- Hover-to-translate floating tooltip (a lightweight Yomitan-style lookup) ----

  const yomitanCache = new Map(); // word -> { reading, meanings } | "error" | null (confirmed miss)
  let yomitanHoverTimer = null;
  let yomitanCurrentTarget = null;
  let yomitanTooltipEl = null;

  function ensureYomitanTooltip() {
    if (yomitanTooltipEl) return yomitanTooltipEl;
    const el = document.createElement("div");
    el.id = "yomitanTooltip";
    el.className = "yomitan-tooltip hidden";
    document.body.appendChild(el);
    yomitanTooltipEl = el;
    return el;
  }

  function hideYomitanTooltip() {
    if (yomitanTooltipEl) yomitanTooltipEl.classList.add("hidden");
    clearTimeout(yomitanHoverTimer);
    yomitanCurrentTarget = null;
  }

  function positionYomitanTooltip(targetEl) {
    const tooltip = ensureYomitanTooltip();
    const rect = targetEl.getBoundingClientRect();
    const tw = tooltip.offsetWidth || 220;
    let left = rect.left + rect.width / 2 - tw / 2;
    left = Math.max(8, Math.min(left, window.innerWidth - tw - 8));
    let top = rect.top - tooltip.offsetHeight - 10;
    if (top < 8) top = rect.bottom + 10; // flip below the word if there's no room above
    tooltip.style.left = `${left}px`;
    tooltip.style.top = `${top + window.scrollY}px`;
  }

  function renderYomitanResult(word, payload) {
    const tooltip = ensureYomitanTooltip();
    if (payload === "error") {
      tooltip.innerHTML = `<div class="yomitan-word-head">${escapeHtml(word)}</div><div class="yomitan-meaning">Lookup failed — try again</div>`;
    } else if (!payload) {
      tooltip.innerHTML = `<div class="yomitan-word-head">${escapeHtml(word)}</div><div class="yomitan-meaning">No dictionary entry found</div>`;
    } else {
      tooltip.innerHTML = `
        <div class="yomitan-word-head">${escapeHtml(word)}${payload.reading ? ` <span class="yomitan-reading">${escapeHtml(payload.reading)}</span>` : ""}</div>
        <div class="yomitan-meaning">${escapeHtml(payload.meanings.join(", ") || "—")}</div>
      `;
    }
  }

  /** Fetch (or reuse a cached) Jisho lookup for a hovered/tapped word and
   *  show it in the floating tooltip, positioned relative to that word. */
  async function showYomitanLookup(targetEl) {
    const word = targetEl.getAttribute("data-word");
    const tooltip = ensureYomitanTooltip();
    tooltip.classList.remove("hidden");

    if (yomitanCache.has(word)) {
      renderYomitanResult(word, yomitanCache.get(word));
      positionYomitanTooltip(targetEl);
      return;
    }

    tooltip.innerHTML = `<div class="yomitan-loading">Looking up…</div>`;
    positionYomitanTooltip(targetEl);
    try {
      ...
      const payload = best
        ? (() => {
            const { reading, meanings } = vocabDisplayFields(best);
            return { reading, meanings: meanings.slice(0, 3) };
          })()
        : null;
      yomitanCache.set(word, payload);
      // Only paint the result if the learner is still on this exact word
      // (they may have moved to a different one while the request was in flight)
      if (yomitanCurrentTarget === targetEl) {
        renderYomitanResult(word, payload);
        positionYomitanTooltip(targetEl);
      }
    } catch {
      yomitanCache.set(word, "error");
      if (yomitanCurrentTarget === targetEl) {
        renderYomitanResult(word, "error");
        positionYomitanTooltip(targetEl);
      }
    }
  }
  ...
  /** Secondary Jisho call for the Deep-Dive modal's "Vocabulary Context"
   *  section: fetch words that actually CONTAIN this kanji (e.g. 院 ->
   *  病院, 大学院), rather than just showing the character in isolation.
   *  Jisho's keyword search on a single kanji already returns mostly
   *  relevant compounds, but is filtered defensively to only words whose
   *  written form literally includes the character. Non-blocking: called
   *  after the modal's main content is already rendered. */
  async function loadVocabularyContext(char) {
    const el = document.getElementById("modalVocabContext");
    if (!el) return;
    try {
      const results = await searchJisho(char);
      const filtered = results
        .filter((r) => {
          const jp = (r.japanese && r.japanese[0]) || {};
          return jp.word && jp.word.includes(char) && jp.word !== char;
        })
        .slice(0, 5);

      if (filtered.length === 0) {
        el.innerHTML = `<p class="card-meanings">No common compound words found for ${char}.</p>`;
        return;
      }

      el.innerHTML = filtered
        .map((entry) => {
          const { word, reading, meanings, jlptTag } =
            vocabDisplayFields(entry);
          return `
          <div class="context-word-row" data-word="${escapeHtml(word)}" data-reading="${escapeHtml(reading)}" role="button" tabindex="0">
            <ruby class="context-word-ruby">${escapeHtml(word)}${reading ? `<rt>${escapeHtml(reading)}</rt>` : ""}</ruby>
            <span class="context-word-meaning">${escapeHtml(meanings.slice(0, 2).join(", ") || "—")}</span>
            ${jlptTag ? `<span class="jlpt-tag">${jlptTag.toUpperCase()}</span>` : `<span class="jlpt-tag">—</span>`}
          </div>`;
        })
        .join("");
    } catch {
      el.innerHTML = `<p class="card-meanings">Couldn't load vocabulary context right now — the Jisho proxy may be unavailable.</p>`;
    }
  }
    ...
    try {
      ...
      body.innerHTML = `
        ...
        <div class="reading-section">
          <h4>Vocabulary Context — words that use ${detail.kanji}</h4>
          <div id="modalVocabContext" class="vocab-context-list">
            <div class="card-skeleton" style="height:4rem"></div>
          </div>
        </div>
        ...
        ${buildMnemonicSectionHTML(detail.kanji, detail.meanings, "Radicals & Components")}
      ...
      loadVocabularyContext(detail.kanji); // fire-and-forget: fills in once Jisho responds, doesn't block the rest of the modal
    } catch (err) {
  ...
  function flashBackHTML(item) {
    ...
    const mnemonicHTML =
      item.type === "kanji"
        ? buildMnemonicSectionHTML(
            item.char,
            item.meanings,
            "Mental Picture / Mnemonic",
          )
        : "";
  ...
  function switchMode(mode) {
    ...
    if (mode !== "extensive") hideYomitanTooltip();
  ...
  function setupEventListeners() {
    ...
    // Extensive Reading: enter/exit Read Mode
    document
      .getElementById("enterReadModeBtn")
      .addEventListener("click", enterReadMode);
    document
      .getElementById("exitReadModeBtn")
      .addEventListener("click", exitReadMode);

    // Hover-to-translate: desktop hover (debounced) + mobile tap (via the
    // main click delegate below) both drive the same floating tooltip.
    document.addEventListener("mouseover", (e) => {
      const word = e.target.closest(".yomitan-word");
      if (!word || word === yomitanCurrentTarget) return;
      yomitanCurrentTarget = word;
      clearTimeout(yomitanHoverTimer);
      yomitanHoverTimer = setTimeout(() => showYomitanLookup(word), 250);
    });
    ...
    // Clicking anywhere outside a word or the tooltip itself dismisses it
    document.addEventListener("click", (e) => {
      if (
        !e.target.closest(".yomitan-word") &&
        !e.target.closest("#yomitanTooltip")
      )
        hideYomitanTooltip();
    });
    ...
    document.addEventListener("click", (e) => {
      ...
      const contextWordRow = e.target.closest(".context-word-row");
      const yomitanWord = e.target.closest(".yomitan-word");
      ...
      if (contextWordRow) {
        openVocabModal(
          contextWordRow.dataset.word,
          contextWordRow.dataset.reading,
        );
        return;
      }
      if (yomitanWord) {
        e.stopPropagation();
        yomitanCurrentTarget = yomitanWord;
        showYomitanLookup(yomitanWord);
        return;
      }
    });
